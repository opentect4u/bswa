...
@Component({
  selector: 'app-print_group_policy_form',
  templateUrl: './print_group_policy_form.component.html',
  styleUrls: ['./print_group_policy_form.component.css'],
  providers: [DatePipe],
})
export class Print_group_policy_formComponent implements OnInit {
  form_no: any;
  member_id:any;
  WindowObject: any;
  divToPrint: any;
