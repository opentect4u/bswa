...
@Component({
  selector: 'app-child_group_policy',
  templateUrl: './child_group_policy.component.html',
  styleUrls: ['./child_group_policy.component.css'],
  providers: [MessageService,DatePipe],
})
export class Child_group_policyComponent implements OnInit {
  value!: string;
  date!: Date;
