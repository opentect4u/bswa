...
export class Print_stp_formComponent implements OnInit {
  ...
  printDiv() {
    ...
    this.WindowObject.document.writeln('@media print { .center { text-align: center;}' +
      ...
      'tr.table_head_cus td{background: #333; color:#fff; text-align: left; font-size: 14px;}' +
      'tr.table_head_cus th{background: #333; color:#fff; text-align: left; font-size: 14px;}'+

      '.print_Section table tbody tr td{border-bottom:#ccc solid 1px; padding:10px;text-align: left;}' +
      '.print_Section table tbody tr th{border-bottom:#ccc solid 1px; padding:10px;text-align: left;}' +
