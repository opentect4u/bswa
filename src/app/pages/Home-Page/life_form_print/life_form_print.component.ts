...
@Component({
  selector: 'app-life_form_print',
  templateUrl: './life_form_print.component.html',
  styleUrls: ['./life_form_print.component.css'],
  providers: [DatePipe],
})
export class Life_form_printComponent implements OnInit {
