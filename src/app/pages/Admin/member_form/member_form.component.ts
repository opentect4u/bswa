...
@Component({
  selector: 'app-member_form',
  templateUrl: './member_form.component.html',
  styleUrls: ['./member_form.component.css'],
  providers: [MessageService],
})
export class Member_formComponent implements OnInit {
  date!: Date;
  // member!: MemberType[];
        ...
        if (this.savedata.suc > 0) {
          ...
          Swal.fire(
            ...
            if (result.isConfirmed) {
                    this.router.navigate(['/admin/print_form',encodeURIComponent(btoa(this.formNo))])
                  }
                });
