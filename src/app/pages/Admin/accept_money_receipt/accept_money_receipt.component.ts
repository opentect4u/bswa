...
@Component({
  selector: 'app-accept_money_receipt',
  templateUrl: './accept_money_receipt.component.html',
  styleUrls: ['./accept_money_receipt.component.css'],
  providers: [DatePipe],
})
export class Accept_money_receiptComponent implements OnInit {
  WindowObject: any;
  divToPrint: any;
  form_no:any
  ...
  ngOnInit() {
    ...
    this.getAcceptTransactionDetails(this.form_no, this.trn_id)
  }

  getAcceptTransactionDetails(form_no:any, trn_id:any){
    this.dataServe.global_service(1, '/accept_money_receipt',{form_no, trn_id})
          .subscribe((data: any) => {
