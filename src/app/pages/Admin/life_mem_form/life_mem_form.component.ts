...
@Component({
  selector: 'app-life_mem_form',
  templateUrl: './life_mem_form.component.html',
  styleUrls: ['./life_mem_form.component.css'],
  providers: [MessageService],
})
export class Life_mem_formComponent implements OnInit {
  // date!: Date;
  // items!: any[];
  ...
  constructor(private router: Router, private fb: FormBuilder,private route: ActivatedRoute, private dataServe: DataService,private validatorsService: ValidatorsService,  private messageService: MessageService) { }
  ...
  // get member_name() {
  //   return this.form.get('member_name');
  // }
  // get member_op() {
  //   return this.form.get('member_op');
  // }
  // get unit_name() {
  //   return this.form.get('unit_name');
  // }
  // get gurdian_name() {
  //   return this.form.get('gurdian_name');
  // }
  // get gender() {
  ...
  // }
  // get phone_no() {
  //   return this.form.get('phone_no');
  // }
  // get blood_grp() {
  //   return this.form.get('blood_grp');
  // }
  // get staff_no() {
  //   return this.form.get('staff_no');
  // }
  // get personal_no() {
  //   return this.form.get('personal_no');
  // }
  // get min_no() {
  //   return this.form.get('min_no');
  // }
  // get mem_addr() {
  //   return this.form.get('mem_addr');
  // }
  // get pin_no() {
  //   return this.form.get('pin_no');
  // }

  // get spou_name() {
  //   return this.form_1.get('spou_name')
  // }
...
//               //   });
//               // } else {
//               //   Swal.fire('Error', 'Your form is not submitted successfully!', 'error');
//               // }
//             });
//         }
//         Swal.fire(
...
//         ).then((result) => {
//           if (result.isConfirmed) {
//                   this.router.navigate(['/admin/print_life_form',encodeURIComponent(btoa(this.formNo))])
//                 }
//               });
