...
@Component({
  selector: 'app-asso_mem_form',
  templateUrl: './asso_mem_form.component.html',
  styleUrls: ['./asso_mem_form.component.css'],
  providers: [MessageService],
})
export class Asso_mem_formComponent implements OnInit {
  date!: Date;
  items!: any[];
  value!: string;
  ...
  // get mem_name() {
  //   return this.form.get('mem_name');
  // }
  // get guard_name() {
  //   return this.form.get('guard_name');
  // }
  // get gen() {
  //   return this.form.get('gen');
  // }
  // get asso_dob() {
  //   return this.form.get('asso_dob');
  // }
  // get ph_no() {
  //   return this.form.get('ph_no');
  // }
  // get asso_addr() {
  //   return this.form.get('asso_addr');
  // }
  // get pin() {
        ...
        if (this.savedata.suc > 0) {
          ...
          Swal.fire(
            ...
            if (result.isConfirmed) {
                    this.router.navigate(['/admin/print_associate_form',encodeURIComponent(btoa(this.formNo))])
                  }
                });
