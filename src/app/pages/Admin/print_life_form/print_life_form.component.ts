...
@Component({
  selector: 'app-print_life_form',
  templateUrl: './print_life_form.component.html',
  styleUrls: ['./print_life_form.component.css'],
  providers: [DatePipe],
})
export class Print_life_formComponent implements OnInit {
