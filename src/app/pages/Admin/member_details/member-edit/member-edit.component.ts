        ...
        (data) => {
          ...
          if (this.userData.suc > 0) {
            ...
            this.form.patchValue({
              ...
              member_opt: this.memberData?.memb_oprn ? this.memberData?.memb_oprn : '',
              unit_nm: this.memberData?.unit_id ? this.memberData?.unit_id : '',
              member: this.memberData?.memb_name ? this.memberData?.memb_name : 'N/A',
              gurdian: this.memberData?.gurdian_name ? this.memberData?.gurdian_name : 'N/A',
              gen: this.memberData?.gender ? this.memberData?.gender : '',
              marital_status: this.memberData?.marital_status ? this.memberData?.marital_status : '',
              gen_dob: this.memberData?.dob
                ? this.datePipe.transform(this.memberData?.dob, 'yyyy-MM-dd')
                : '',
              phone: this.memberData?.phone_no ? this.memberData?.phone_no : 'N/A',
              email_id: this.memberData?.email_id ? this.memberData?.email_id : 'N/A',
              blood: this.memberData?.blood_grp ? this.memberData?.blood_grp : '',
              caste: this.memberData?.caste ? this.memberData?.caste : '',
